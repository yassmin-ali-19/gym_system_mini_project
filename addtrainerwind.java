...
public class addtrainerwind extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<Trainer> array=admin.getListOfTrainers();
        int flag=0;
        for(Trainer i:array)
        {
            if(i.getSearchKey().equals(id)) 
            {
                flag=1;
                break;
            }
        }
        if(flag==1)JOptionPane.showMessageDialog(this, "the trainer with Id="+id+"aleady exists!", "Message", JOptionPane.ERROR_MESSAGE);
        else {admin.addTrainer(id, name, email, speciality, phonenumber);
