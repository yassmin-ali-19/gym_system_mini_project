...
//    METHODS
    ...
    public void readFromFile(){
        try {
            ...
            while((line = reader.readLine()) != null){
                ...
                Member member = new Member(lineArray[0],lineArray[1],lineArray[2],lineArray[3],lineArray[4],lineArray[5]);
    ...
    public void insertRecord(Member record){
        for(Member r:this.records){
            if(r.getSearchKey().equals(record.getSearchKey())){
                System.out.println("Member already in system!!!");
                return;
            }
        }
    ...
    public void deleteRecord(String key){
        ...
        System.out.println("Member to be deleted not found");
    }
