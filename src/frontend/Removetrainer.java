...
public class Removetrainer extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(admin.removeTrainer(id)==true)
        {
            JOptionPane.showMessageDialog(this, "the trainer with Id="+id+"has been deleted!", "Message", JOptionPane.INFORMATION_MESSAGE);
            dispose();
            new Adminrolewind();
        } else {
            JOptionPane.showMessageDialog(this, "the trianer with Id="+id+"deosnot exist!", "Message", JOptionPane.ERROR_MESSAGE);
          //return;
        }
    ...
    public static void main(String args[]) {
        ...
        /* Create and display the form */
         java.awt.EventQueue.invokeLater(() -> new Removetrainer().setVisible(true));
    }
